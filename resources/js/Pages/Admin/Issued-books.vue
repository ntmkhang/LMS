                ...
                <DataTable class="display nowrap h-full">
                  <thead>
                    <tr class="bg-gray-100">
                      ...
                      <th class="border px-4 py-2 text-left">Fees VND</th>
                  ...
                  <tbody>
                    <tr v-for="(row, index) in books" :key="row.id">
                      ...
                      <td class="border px-4 py-2">{{ row.book_fees }} VND</td>
                      <td class="border px-4 py-2">{{ row.to_return }}</td>
                      <td class="border px-4 py-2 text-white text-center" v-if="row.is_return == 1">
                        <p class="bg-green-500 w-20 rounded">Returned</p>
                      </td>
                      <td class="border px-4 py-2 text-white text-center" v-if="row.is_return == 0">
                        <p class="bg-orange-500 w-20 rounded">On-going</p>
                      </td>
                      <td class="border px-4 py-2 text-white text-center" v-if="row.is_return == 2">
                        <p class="bg-red-500 w-20 rounded">Overdue</p>
                      </td>
                      <td class="border px-4 py-2 h-20">
                        <!-- Actions -->
                        <div class="flex justify-center gap-2">
                          <!-- Edit Action -->
                          <button v-show="row.is_return != 1"
